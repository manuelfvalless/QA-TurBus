...
public class W2E1_Caso009Android {

	private WebDriver driver;
	private String baseUrl;
	private StringBuffer verificationErrors = new StringBuffer();
	Mantis mantis = new Mantis();
	private static final String EVIDENCIA = "C:/jenkins/workspace/Web2.0/bin/web2_0/evidencia/W2E1_Caso009Android";
	private static final String EVIDENCIAZIP = "C:/jenkins/workspace/Web2.0/bin/web2_0/evidencia/testW2E1_Caso009Android.zip";
	...
	@Test
    public void testW2E1_Caso009Android() throws Exception{//Compra ida y vuelta Santiago Viña del Mar 3 pasajeros
        try {
        driver.get(baseUrl);
        Thread.sleep(3000);
