...
public class W2E1_Caso008 {
    ...
    Mantis mantis = new Mantis();
   	private static final String EVIDENCIA = System.getProperty("user")+"bin/web2_0/evidencia/W2E1_Caso008";
   	private static final String EVIDENCIAZIP = System.getProperty("user")+"bin/web2_0/evidencia/testW2E1_Caso008.zip";
    ...
    @Test
    public void testW2E1_Caso008() throws Exception{//Compra ida y vuelta Santiago - Copiapo 2 pasajeros
        try {
        ...
        logEjecucion.append("Ciudad destino Copiapo ");
        getFoto(driver);
        Thread.sleep(1000);
        driver.findElement(By.xpath("//div[2]/div[2]/ul/li")).click();
        logEjecucion.append("Selecciona de la lista ciudad Copiapo ");
        getFoto(driver);
        Thread.sleep(1000);
        ...
        getFoto(driver);
        Thread.sleep(1000);
        js.executeScript("window.scrollBy(0,-750)");//scroll hacia arriba
        getFoto(driver);
        Thread.sleep(1000);
