...
public class W2E1_Caso003Safari {

	private WebDriver driver;
	private String baseUrl;
	private StringBuffer verificationErrors = new StringBuffer();
	Mantis mantis = new Mantis();
	private static final String EVIDENCIA = "/Users/MAC-Inovabiz/jenkins/workspace/Web_2.0_Safari/bin/web2_0/evidencia/W2E1_Caso003Safari/";
	private static final String EVIDENCIAZIP = "/Users/MAC-Inovabiz/jenkins/workspace/Web_2.0_Safari/bin/web2_0/evidencia/testW2E1_Caso003Safari.zip";
	...
	@Test
	public void testW2E1_Caso003() throws Exception {// Compra sólo ida, Santigo - Concepción 2 pasajeros
		try {
			driver.get(baseUrl);
			Thread.sleep(6000);
