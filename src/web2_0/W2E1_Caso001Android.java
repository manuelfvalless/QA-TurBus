...
public class W2E1_Caso001Android {

	private WebDriver driver;
    private String baseUrl;
    private StringBuffer verificationErrors = new StringBuffer();
    Mantis mantis = new Mantis();
	private static final String EVIDENCIA = "C:/jenkins/workspace/Web2.0/bin/web2_0/evidencia/W2E1_Caso001Android";
	private static final String EVIDENCIAZIP = "C:/jenkins/workspace/Web2.0/bin/web2_0/evidencia/testW2E1_Caso001Android.zip";
    ...
    public void testW2E1_Caso001() throws Exception {//Script de la prueba
        ...
        logEjecucion.append("Selección de asiento del pasajero ");
        getFoto(driver);
        Thread.sleep(1000);
        ...
        getFoto(driver);
        driver.findElement(By.xpath("//li/button")).click();
        logEjecucion.append("Selección datos del comprador  ");
        getFoto(driver);
        Thread.sleep(1000);
