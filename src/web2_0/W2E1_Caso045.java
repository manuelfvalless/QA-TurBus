...
public class W2E1_Caso045 {
	...
	private static final String EVIDENCIA = "C:/jenkins/workspace/Web2.0/bin/web2_0/evidencia/W2E1_Caso045";
	private static final String EVIDENCIAZIP = "C:/jenkins/workspace/Web2.0/bin/web2_0/evidencia/testW2E1_Caso045.zip";
	...
	public void testW2E1_Caso045() throws Exception{
		try {
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//span[3]/button")).click();
			logEjecucion.append("Selecciona 5 pasajeros ");
			getFoto(driver);
			Thread.sleep(1000);
