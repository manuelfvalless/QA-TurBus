...
public class W2E1_Caso028_029_030_031 {
	...
	private static final String EVIDENCIA = "C:/jenkins/workspace/Web2.0/bin/web2_0/evidencia/W2E1_Caso028_029_030_031";
	private static final String EVIDENCIAZIP = "C:/jenkins/workspace/Web2.0/bin/web2_0/evidencia/testW2E1_Caso028_029_030_031.zip";
    ...
    public void testW2E1_Caso028_029_030_031() throws Exception{
        ...
        logEjecucion.append("Selecciona cantidad de pasajeros ");
        getFoto(driver);
        Thread.sleep(1000);
        try {
        ...
        for (int i = 1; i <= asientoIda; i++) {
            ...
            logEjecucion.append("Selecciona asiento de pasajero 1 y 2 ");
            getFoto(driver);
            Thread.sleep(1000);
        }
